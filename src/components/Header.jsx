    ...
    >
      <div className="container mx-auto flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center space-x-8">
          ...
          {/* Contact Button  */}
          <button
            className="flex items-center space-x-2 bg-zinc-900 text-white text-sm py-4 px-6 rounded-full cursor-pointer
             transition-all duration-150 ease-in ml-4 hover:bg-transparent border border-zinc-900 hover:text-zinc-900 "
          >
            <Phone size={16} />
